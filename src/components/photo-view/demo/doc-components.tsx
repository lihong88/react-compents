...
export const ImageList: React.FC<any> = ({ children }: any) => {
  ...
  ({ src, ...props }, ref) => {
    return (
      <img
        ref={ref}
        src={src}
        className="mr-2 mb-2 w-24 h-24 cursor-pointer object-cover"
        alt=""
        {...props}
      />
    );
...
export const Overlay: React.FC<any> = ({ children }: any) => {
  return (
